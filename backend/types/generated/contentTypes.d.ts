...
export interface ApiQuoteQuote extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    pricePerPound: Schema.Attribute.Decimal;
    countryOfOrigin: Schema.Attribute.String;
    minimumOrderQuantity: Schema.Attribute.Integer;
    supplier: Schema.Attribute.Relation<'oneToOne', 'api::supplier.supplier'>;
    certifications: Schema.Attribute.String;
    summary: Schema.Attribute.Relation<'oneToOne', 'api::summary.summary'>;
...
export interface ApiRfqRfq extends Struct.CollectionTypeSchema {
  collectionName: 'rfqs';
  info: {
    singularName: 'rfq';
    pluralName: 'rfqs';
  ...
  attributes: {
    ...
    requiredAmount: Schema.Attribute.BigInteger;
    quotes: Schema.Attribute.Relation<'oneToMany', 'api::quote.quote'>;
    shipToAddress: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    publishedAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::rfq.rfq'>;
  };
}
...
export interface ApiSummarySummary extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    quote: Schema.Attribute.Relation<'oneToOne', 'api::quote.quote'>;
    createdAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    publishedAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
